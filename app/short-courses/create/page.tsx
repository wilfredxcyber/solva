    ...
    <div className="min-h-screen bg-[#FAF8F8] flex flex-col">
      ...
      <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-4 px-4 sm:px-8 pt-6 sm:pt-8 pb-4">
        ...
        <div className="flex items-center gap-3">
          ...
          <button className="flex-1 sm:flex-none px-4 py-2 rounded-lg bg-primary text-white text-sm font-semibold hover:bg-primary/90 transition-colors shadow-sm">
            Save Course
          </button>
        </div>
      </div>
      ...
      {/* Bottom Footer */}
      <div className="fixed bottom-0 left-0 right-0 bg-white border-t border-gray-100 px-4 sm:px-8 py-3 sm:py-4 flex flex-col-reverse sm:flex-row sm:items-center sm:justify-end gap-2 sm:gap-4">
        <button
          onClick={() => router.push("/short-courses")}
        ...
        <button className="w-full sm:w-auto px-5 py-2.5 rounded-lg border border-gray-300 text-gray-700 text-sm font-medium hover:bg-gray-50 transition-colors">
          Save as Draft
        </button>
        <button className="w-full sm:w-auto flex items-center justify-center gap-2 px-5 py-2.5 rounded-lg bg-primary text-white text-sm font-semibold hover:bg-primary/90 transition-colors shadow-sm">
